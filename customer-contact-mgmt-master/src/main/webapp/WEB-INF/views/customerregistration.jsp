               ...
               <div class="form-group row">
                   ...
                   <div class="col-sm-2"> 
                       <label for="lastContact">Last Contact<span class="blue">*</span></label>                       
                        <form:input type="date" class="form-control input-sm" path="lastContact" id="lastContact"  />
                        <div class="has-error">
                    ...
                    <div class="col-sm-2">
                        ...
                        <form:input type="date" class="form-control input-sm" path="nextContact" id="nextContact"  />
                        <div class="has-error">
		  ...
		  <div class="form-group row">
            <div class="col-sm-12">
				<div class="form-actions floatRight">
					<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/customerslist' />">Cancel</a>
						</c:when>
						<c:otherwise>
							<input type="submit" value="Register" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/customerslist' />">Cancel</a>
						</c:otherwise>
					</c:choose>		 							
	      </div>
	      </div>
